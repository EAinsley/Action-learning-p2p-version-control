...
\begin{titlepage}
    ...
    \vspace{1cm}
    \textbf{Advisor:} Thomas Broussard\\
    \vfill
    \today
\end{titlepage}
...
\note{Include Flesch Reading Ease and Flesch-Kincaid Grade Level statistics here as required by the coordinator.}

\todo{All: compute and include readability stats after final text edits.}
